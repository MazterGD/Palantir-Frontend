...
import { PLANET_TEXTURES, PLANETS } from "@/app/lib/data/planet";
import { Line2 } from "three/examples/jsm/lines/Line2.js";
import {
  OrbitGenerator,
  ScaledOrbitGenerator,
  ORBIT_PRESETS,
} from "../orbit/OrbitGenerator";
import { addObjectLabel } from "../rendering/Halo";
import { createLabel } from "../rendering/Label";
...
export const createPlanet = (
  ...
  (orbitLine as any).originalEmissiveIntensity =
