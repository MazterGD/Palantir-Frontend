...
import { Point3D, OrbitElements, OrbitPosition, OrbitLineOptions } from "@/app/lib/types/orbit";
...
export class OrbitGenerator {
  ...
  generateOrbitLine(options: OrbitLineOptions = {}): Line2 {
    ...
    const lineW = isMobileDevice() ? 1.5 : 3;
...
export type { Point3D, OrbitElements, OrbitPosition, OrbitLineOptions };
